...
export type GrvscCodeBlockTokenizedLinesTokens = {
  ...
  defaultThemeTokenData?: Maybe<
    GrvscCodeBlockTokenizedLinesTokensDefaultThemeTokenData
  >
  className?: Maybe<Scalars["String"]>
  html?: Maybe<Scalars["String"]>
}
...
export type GrvscCodeBlockTokenizedLinesTokensFilterInput = {
  ...
  defaultThemeTokenData?: Maybe<
    GrvscCodeBlockTokenizedLinesTokensDefaultThemeTokenDataFilterInput
  >
  className?: Maybe<StringQueryOperatorInput>
  html?: Maybe<StringQueryOperatorInput>
}
...
export type NotesPageQueryQueryVariables = {}

export type NotesPageQueryQuery = {
  allMarkdownRemark: {
    edges: Array<{
